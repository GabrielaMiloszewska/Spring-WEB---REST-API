...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        //Given
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "created card Dto test","url");
        TrelloCardDto trelloCardDto = new TrelloCardDto("card Dto test", "covering tests: create card DTO test", "first", "1");
        TrelloCard trelloCard = new TrelloCard("card test", "covering tests: create card test", "first", "1");
        ...
        System.out.println("Expected card information: " + cardDto.getId() + ", " + cardDto.getName() + ", " + cardDto.getShortUrl());

        //Then
        assertThat(cardDto).isNotNull();
        assertEquals("1", cardDto.getId());
        assertEquals("created card Dto test", cardDto.getName());
        assertEquals("url", cardDto.getShortUrl());
    }
